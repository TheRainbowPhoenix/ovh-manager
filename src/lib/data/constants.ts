export type Constant = {
	...
	vrackUrl?: string;
	UNIVERS: string;
	SECTIONS_UNIVERSE_MAP: { [key: string]: string[] };
	URLS: { [locale: string]: any };
	website_url: { [new_nic: string]: { [locale: string]: string } };
	TOP_GUIDES: { [key: string]: any };
	accountCreation: { [locale: string]: string };
	billingRenew: { [locale: string]: string };
	SUPPORT: { [locale: string]: string };
};
...
let constants: {
		...
		URLS: {
			CZ: {
				...
				guides: {
					...
					vrack: 'https://docs.ovh.com/cz/cs/dedicated/konfigurace-dedikovanych-serveru-vrack/'
				},
				presentations: {
			...
			ES: {
				...
				guides: {
					...
					vrack: 'https://docs.ovh.com/es/dedicated/configurar-vrack-en-servidor-dedicado/'
				},
				presentations: {
			...
			GB: {
				...
				guides: {
					...
					vrack: 'https://docs.ovh.com/gb/en/dedicated/configuring-vrack-on-dedicated-servers/'
				},
				presentations: {
			...
			IT: {
				...
				guides: {
					...
					vrack: 'https://docs.ovh.com/it/dedicated/configurare-server-dedicati-vrack/'
				},
				presentations: {
			...
			LT: {
				...
				guides: {
					...
					vrack: 'https://docs.ovh.com/lt/dedicated/configuring-vrack-on-dedicated-servers/'
				},
				presentations: {
			...
			PL: {
				...
				guides: {
					...
					vrack: 'https://docs.ovh.com/pl/dedicated/konfiguracja-kilku-serwerow-dedykowanych-vrack/'
				},
				presentations: {
			...
			IE: {
				...
				guides: {
					...
					vrack: 'https://docs.ovh.com/ie/en/dedicated/configuring-vrack-on-dedicated-servers/'
				},
				presentations: {
			...
			pcc: {
				fr_FR: [
					...
					},
					{
						...
						url: 'https://docs.ovh.com/fr/private-cloud/suppression-serveur-hote/#supprimer-le-serveur-hote'
					},
					{
				...
				de_DE: [
					{
						title: 'core_pcc_top_guide_1_title',
						atInternetClickTag: 'TopGuide-PrivateCloud-1',
						url: 'https://docs.ovh.com/de/private-cloud/den_vsphere_client_installieren/'
					},
					{
						title: 'core_pcc_top_guide_2_title',
						atInternetClickTag: 'TopGuide-PrivateCloud-2',
						url: 'https://docs.ovh.com/de/private-cloud/virtuelle-maschine-deployen/'
					},
					{
						title: 'core_pcc_top_guide_3_title',
						atInternetClickTag: 'TopGuide-PrivateCloud-3',
						url: ' https://docs.ovh.com/de/private-cloud/ip-server-konfiguration/'
					},
					{
						title: 'core_pcc_top_guide_4_title',
						atInternetClickTag: 'TopGuide-PrivateCloud-4',
						url: 'https://docs.ovh.com/de/private-cloud/nderung_der_hardware-konfiguration_einer_virtuellen_maschine/'
					},
					{
						title: 'core_pcc_top_guide_5_title',
						atInternetClickTag: 'TopGuide-PrivateCloud-5',
					...
					},
					{
						title: 'core_pcc_top_guide_10_title',
						atInternetClickTag: 'TopGuide-PrivateCloud-10',
						url: 'https://docs.vmware.com/de/VMware-NSX-Data-Center-for-vSphere/index.html'
					}
				],
				en_GB: [
					{
	...
	CA: {
		...
		accountCreation: {
			...
			en_CA: 'http://www.ovh.com/ca/en/support/new_nic.xml',
			en_GB: 'http://www.ovh.com/us/support/new_nic.xml',
		...
		billingRenew: {
			AU: 'https://ca.ovh.com/au/cgi-bin/order/renew.cgi?domainChooser={serviceName}',
			CA: 'https://ca.ovh.com/fr/cgi-bin/order/renew.cgi?domainChooser={serviceName}',
			CZ: 'https://www.ovh.cz/cgi-bin/order/renew.cgi?domainChooser={serviceName}',
			DE: 'https://www.ovh.de/cgi-bin/order/renew.cgi?domainChooser={serviceName}',
			EN: 'https://www.ovh.co.uk/cgi-bin/order/renew.cgi?domainChooser={serviceName}',
			...
			QC: 'https://ca.ovh.com/fr/cgi-bin/order/renew.cgi?domainChooser={serviceName}',
			RU: 'https://www.ovh.co.uk/cgi-bin/order/renew.cgi?domainChooser={serviceName}',
			SG: 'https://ca.ovh.com/sg/cgi-bin/order/renew.cgi?domainChooser={serviceName}',
			SN: 'https://www.ovh.sn/cgi-bin/order/renew.cgi?domainChooser={serviceName}',
			TN: 'https://www.ovh.com/tn/cgi-bin/order/renew.cgi?domainChooser={serviceName}',
			WE: 'https://ca.ovh.com/fr/cgi-bin/order/renew.cgi?domainChooser={serviceName}'
		},
	...
	US: {
			...
			US: {
				...
				guides: {
					...
					reinitPassword:
						'http://docs.ovh.ca/en/faqs-server-issues.html#server-password-lost-forgotten',
					ipv6Vps: 'https://www.ovh.com/ca/en/g2365.vps-ipv6',
					nsx: 'https://us.ovhcloud.com/enterprise/products/hosted-private-cloud/nsx-datacenter-vsphere/',
					vrops: 'https://us.ovhcloud.com/enterprise/products/hosted-private-cloud/vrops/'
				},
				presentations: {
		...
		TOP_GUIDES: {
			all: 'https://support.us.ovhcloud.com/hc/en-us/categories/115000423390-Dedicated-Servers',
			sd: {
				en_GB: [
					{
						title: 'core_sd_top_guide_7_title',
